...
[Hier](data_on_git/Ensembl_102_GRCm38.p6_Gene_names.tsv) finden Sie eine Tabelle, die die Gen-IDs den Gen-Symbolen (Gen-Namen) zuordnet. Fügen Sie auch diese Tabelle hinzu.

```{r echo=FALSE,message=FALSE}
long_tbl %>%
left_join( sample_table ) %>%
left_join( read_tsv( "data_on_git/Ensembl_102_GRCm38.p6_Gene_names.tsv" ), by="gene_id" ) -> long_tbl
```
