...
***Anmerkung**: Wenn Sie sih den Fragebogen ansehen, veranlasst Sie das vielleicht, die neun Fragen für sich selbst zu beantworten. Möglichweise erreichen Sie dabei eine Punktzahl erreicht, die auf eine Depression hindeutet. In diesem Fall möchten Sie vielleicht den Hinweis lesen, den ich am Ende angefügt haben.*
...
*Ersatzlösung:* Hier finden Sie eine Tabelle mit zwei Spalten: der Probanden-ID, und der DHQ9-Punktsumme: [dpq9_j_score_sums.csv](https://papagei.bioquant.uni-heidelberg.de/simon/Vl2223/dpq9_j_score_sums.csv) <small>[Diese Datei wurde am 26.12. ersetzt.]</small>
